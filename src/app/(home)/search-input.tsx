        ...
        <div className='flex-1 flex items-center justify-center'>
            <form className='relative max-w-[720px] w-full' onSubmit={handleSubmit}>
                ...
                <Button
                    ...
                    variant={"ghost"}
                    size={"icon"}
                    className='absolute left-3 top-1/2 -translate-y-1/2 [&_svg]:w-5 [&_svg]:h-5 rounded-full'
                >
                    <SearchIcon />
                </Button>
                {
                    value && (
                        <Button
                            ...
                            variant={"ghost"}
                            size={"icon"}
                            className='absolute right-3 top-1/2 -translate-y-1/2 [&_svg]:w-5 [&_svg]:h-5 rounded-full'
                        >
                            <XIcon />
                        </Button>
                    )
